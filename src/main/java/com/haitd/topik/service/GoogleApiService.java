...
public class GoogleApiService {
    private final String APPLICATION_NAME = "Topik Register";
    private final JacksonFactory JSON_FACTORY = JacksonFactory.getDefaultInstance();
    private final String TOKENS_DIRECTORY_PATH = "tokens";
    private final List<String> SCOPES = List.of(DriveScopes.DRIVE, SheetsScopes.SPREADSHEETS_READONLY);
    ...
    public List<List<Object>> getDataFromSheet() throws IOException, GeneralSecurityException {
        ...
        final String spreadsheetId = "1hR2xQp515RDclOjmJqUegtCEM8VyyFf_K8aIOUciFEw";
        String range = "Current!A2:N";
        ...
        System.out.println("Number of account: " + values.size());
        return values;
    }
